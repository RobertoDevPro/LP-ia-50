      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-purple-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-purple-100">
            ...
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed text-center mt-6">
              Foi por isso que a Mônica criou esse material — pra mostrar que a Inteligência Artificial pode facilitar
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 sm:p-8 mb-8 border border-white/20">
            ...
            <div className="space-y-4">
              ...
              <a
                href="https://wa.me/5511989397173?text=Olá! Tenho dúvidas sobre o curso de IA Descomplicada 50%2B"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center bg-green-500 hover:bg-green-600 text-white font-bold text-lg sm:text-xl px-4 sm:px-12 py-5 sm:py-6 rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
